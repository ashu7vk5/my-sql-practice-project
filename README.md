# my-sql-practice-project ER Diagram – IT Service Desk & Incident Management System
...
To design and implement a MySQL-based IT Service Desk & Incident Management System that centralizes support ticket tracking, technician assignments, incident resolution, and team performance reporting. The system addresses the business challenge of managing IT support requests efficiently, reducing manual tracking, improving response visibility, and enabling data-driven operational reporting through SQL.

**IT_Service_Desk_Management_System.sql**
